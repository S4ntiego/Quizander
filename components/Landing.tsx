...
const Landing = () => {
  return (
    <section className="mt-[4.5rem] flex-1 flex flex-col container justify-center items-center text-center font-lexend bg-gradient-to-t from-dark-700 via-dark-600 to-dark-700 py-8">
      ...
      <h1 className="font-bold leading-tight font-dancingscript text-6xl tracking-tighter text-yellow-500">
        Harry Potter Trivia
      </h1>
      <p className="mt-2 flex items-center justify-center px-4 text-dark-150"></p>
      <div className="relative flex justify-center items-center h-72 w-screen">
        <div className="absolute h-64 w-64 rounded-full bg-gradient-to-t from-dark-500 to-dark-700 border dark:border-dark-500"></div>
        <Image
