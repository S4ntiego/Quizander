...
export function SiteHeader({ mainConfig, mobileConfig }: SiteHeaderProps) {
  ...
  return (
    <div className="sticky flex-initial container py-4 items-center flex justify-between top-0 z-40 border-b border-b-slate-200 bg-white dark:border-b-slate-700 dark:bg-slate-900">
